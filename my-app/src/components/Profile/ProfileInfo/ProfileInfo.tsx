    ...
    return (
        <div>
            ...
            <div className={s.descriptionBlock}>
                <img src={profile.photos.large || profile.photos.small || DefaultImg} alt="" className={s.defaultImg}/>
...
const ProfileData: React.FC<TProfileData> = ({profile, isOwner, goToEditMode}) => {
    return <div>
        {isOwner && <div>
        ...
        <div>
            ...
            {profile.lookingForAJob
                ? <i className="em em---1" aria-label="THUMBS UP SIGN"/>
                : <i className="em em--1" aria-label="THUMBS DOWN SIGN"/>}
        </div>
        <div>
          <span>
        ...
        <div>
            ...
            {Object.keys(profile.contacts).map(contact => {
                return <Contact key={contact} contactTitle={contact} contactValue={profile.contacts[contact as keyof TContacts]}/>
            })}
        </div>
    </div>
};
